...
쫀득연구소 랜딩페이지 전용 컴포넌트. 브랜드 테마(jjonddeuk)와 함께 사용.

### Atomic 컴포넌트

- CharacterComment: 쫀득이 코멘트 말풍선. bubble/inline 변형 (`sections/jjonddeuk/components/CharacterComment.jsx`)
- RecipeBadge: 레시피 메타 배지. difficulty/time/yield 타입 (`sections/jjonddeuk/components/RecipeBadge.jsx`)
- ChecklistItem: 재료 체크리스트 아이템. 체크 시 취소선 (`sections/jjonddeuk/components/ChecklistItem.jsx`)
...
- RecipeOverview: 레시피 개요 바. RecipeBadge 3개 조합 (`sections/jjonddeuk/components/RecipeOverview.jsx`)
- IngredientChecklist: 카테고리별 재료 체크리스트 (`sections/jjonddeuk/components/IngredientChecklist.jsx`)
- StepList: 단계별 카드 목록. 스크롤 페이드인 (`sections/jjonddeuk/components/StepList.jsx`)
- StorageInfo: 보관 정보 패널 (`sections/jjonddeuk/components/StorageInfo.jsx`)
...
- JjonddeukLandingPage: 쫀득연구소 랜딩 페이지 (`pages/JjonddeukLandingPage.jsx`)
